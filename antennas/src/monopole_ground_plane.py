...
design_freq_mhz = 143.05
lte_high_band = [100, 170]
system_impedance = 50
...
if (__name__ == '__main__'):
  ...
  ground_wire_length = wavelength / 4
  ...
  geo_opt.radiation_pattern(thetas=Range(-90, 90, count=180), phis=Range(0,90,count=90))
